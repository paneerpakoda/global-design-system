...
enum GlobalDSColors {
    ...
    static let brandOrange = Color(.sRGB, red: 0.8902, green: 0.3255, blue: 0.0588, opacity: 1)
    ...
    static let neutralBaseWhite = Color(.sRGB, red: 1.0, green: 1.0, blue: 1.0, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.60
    static let neutralGrey60 = Color(.sRGB, red: 0.9686, green: 0.9686, blue: 0.9686, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.70
    static let neutralGrey70 = Color(.sRGB, red: 0.9059, green: 0.9098, blue: 0.9137, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.80
    static let neutralGrey80 = Color(.sRGB, red: 0.8039, green: 0.8118, blue: 0.8157, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.90
    static let neutralGrey90 = Color(.sRGB, red: 0.698, green: 0.7098, blue: 0.7216, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.100
    static let neutralGrey100 = Color(.sRGB, red: 0.5922, green: 0.6078, blue: 0.6235, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.110
    static let neutralGrey110 = Color(.sRGB, red: 0.4902, green: 0.5098, blue: 0.5294, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.120
    static let neutralGrey120 = Color(.sRGB, red: 0.3922, green: 0.4118, blue: 0.4275, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.130
    static let neutralGrey130 = Color(.sRGB, red: 0.298, green: 0.3098, blue: 0.3216, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.140
    static let neutralGrey140 = Color(.sRGB, red: 0.2, green: 0.2118, blue: 0.2196, opacity: 1)
    // TOKEN_COLOR: color.neutralGrey.150
    static let neutralGrey150 = Color(.sRGB, red: 0.1255, green: 0.1412, blue: 0.1569, opacity: 1)
    // TOKEN_COLOR: color.surfaceCoolGrey.90
    static let surfaceCoolGrey90 = Color(.sRGB, red: 0.9882, green: 0.9882, blue: 0.9922, opacity: 1)
...
enum GlobalDSSpacing {
    ...
    static let spaceXl2: CGFloat = 24
    static let spaceXl3: CGFloat = 32
    static let spaceXl4: CGFloat = 40
    static let spaceXl5: CGFloat = 48
    static let spaceXl6: CGFloat = 64
}
