...
test('brands the application shell as GlobalDS OS', () => {
  const index = read('index.html');
  const app = read('js/app.js');

  assert.match(index, /<title>GlobalDS OS · ICICI Bank<\/title>/);
  assert.match(index, /<strong>GlobalDS OS<\/strong>/);
  assert.match(app, /GlobalDS OS/);
