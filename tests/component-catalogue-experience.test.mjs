...
const alphabeticalComponentIds = ["accordions", "activity-timeline", "avatar", "breadcrumbs", "button", "calendar", "cards", "checkbox", "chip", "dropdown", "emptystate", "info", "textfield", "label", "lists", "loadingindicator", "otp", "radio", "segmented", "stepper", "toggle", "upload"];
