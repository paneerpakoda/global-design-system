...
test('publishes Accordion and Activity timeline across the catalogue and playground', () => {
  ...
  assert.match(components, /const PUBLISHED_COMPONENT_IDS = Object\.freeze\(\['accordions','activity-timeline','avatar','breadcrumbs','button','calendar','cards','checkbox','chip','dropdown','emptystate','info','textfield','label','lists','loadingindicator','otp','radio','segmented','stepper','toggle','upload'\]\)/);
