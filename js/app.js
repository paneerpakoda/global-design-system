...
function renderHome(){
  ...
  <section class="section">
    ...
    <div class="cards-grid">
      ...
      <div class="link-card" style="cursor:default" data-tilt="3" data-spotlight><i class="ti ti-code"></i><h3>Engineering</h3><p>Install one versioned Flutter package with governed foundations, theme, and components.</p></div>
    </div>
  </section>
  <section class="section">
  ...
  <section class="section">
    ...
    <div class="cards-grid feature-showcase">
      <div class="link-card product-fragment" style="cursor:default" data-tilt="3" data-spotlight>
        ...
        <p>Flutter foundations and theme stay tied to the same governed token object used by this portal.</p>
      </div>
      <div class="link-card product-fragment" style="cursor:default" data-tilt="3" data-spotlight>
        <div class="fragment-stage">
      ...
      <div class="link-card product-fragment" style="cursor:default" data-tilt="3" data-spotlight>
        ...
        <p>The Developers page shows how to install the package, apply its theme, and use its components.</p>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    ...
    <div class="cards-grid">
      ...
      <div class="link-card" style="cursor:default" data-tilt="3" data-spotlight><i class="ti ti-code"></i><h3>One source, Flutter-native output</h3><p>The supported package API is generated from the same governed token identity used by the component library.</p></div>
    </div>
  </section>`;
}
...
function renderDevelopers(){
  let html = pageHeader({
    crumbs:['Developers','Flutter'],
    title:'Flutter package',
    status:'stable',
    version:DS.meta.version,
    updated:DS.meta.updated,
    noResources:true,
    desc:'Install GlobalDS as a versioned Flutter dependency and consume its governed foundations, Material theme, and components through one package import.'
  });
  ...
  global_ds:
    ...
    guidance:{
      ...
      html:'<p class="guidance-note">Update <code>ref</code> only after reviewing the package changelog and running the consuming application’s Flutter tests. Do not depend on <code>main</code> for production builds.</p>'
    }
  });

  html += sectionHtml({
    title:'2 · Import GlobalDS',
    html:codeblock(`import 'package:global_ds/global_ds.dart';`, 'dart'),
    guidance:{
      label:'Typeface included',
      html:'<p class="guidance-note">Mulish Regular, SemiBold, and Bold ship with the package. Applications do not need <code>google_fonts</code> or separate font registration.</p>'
    }
  });

  html += sectionHtml({
    title:'3 · Apply the theme',
    html:codeblock(`MaterialApp(
  title: 'ICICI Bank',
  theme: DsTheme.light,
  ...
  html += sectionHtml({
    title:'4 · Use components',
    html:codeblock(`RibButton(
  label: 'Continue',
  ...
  onPressed: submitTransfer,
    ...
    guidance:{
      ...
      html:'<p class="guidance-note">Package components resolve colour, typography, spacing, radius, and effects through the generated GlobalDS foundations. Product applications should use the exported APIs instead of recreating values.</p>'
    }
  });
