...
class RibLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final foreground = isBadge &&
        ...
        : colors.foreground;
    final background =
        isBadge ? _badgeBackground ?? colors.background : colors.background;
    return Semantics(
      label: text,
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              text,
              style: (size == RibLabelSize.iconLarge
                      ? DsText.p3Semi
                      : DsText.p3Reg)
  ...
  BorderRadius get _radius => size == RibLabelSize.badge
      ? const BorderRadius.vertical(top: Radius.circular(DsRadius.xs))
      : BorderRadius.circular(
          size == RibLabelSize.iconLarge || size == RibLabelSize.large
              ? DsRadius.sm
              : DsRadius.xs,
        );
